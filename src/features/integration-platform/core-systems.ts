...
const BUILTIN_CONNECTORS: ConnectorDefinition[] = [
  ...
  { id: "stripe", name: "Stripe", category: "payment", description: "Process payments via Stripe", authMethods: ["api_key"], capabilities: ["process_payments", "manage_subscriptions", "issue_refunds"], configSchema: {}, version: "1.0.0" },
