/** GET /api/game-modes/battle/advancement — Battle Royale advancement events (read-only) */
import { NextResponse } from "next/server";
import { withErrorHandler } from "@/lib/errors";
import { getAuthContext } from "@/features/auth";
import { getAdvancementEvents, getByes, getTournament } from "@/features/game-modes/battle-royale";
