/** GET /api/game-modes/battle/seeding — Battle Royale seeding (read-only) */
import { NextResponse } from "next/server";
import { withErrorHandler } from "@/lib/errors";
import { getAuthContext } from "@/features/auth";
import { getTournament } from "@/features/game-modes/battle-royale";
...
export const GET = withErrorHandler(async (req: Request) => {
  ...
  return NextResponse.json({
    strategy: tournament.seedingStrategy,
    seedingResults: tournament.seedingResults,
