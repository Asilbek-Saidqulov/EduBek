/** GET /api/notifications/developer — Developer integration metadata */
import { NextResponse } from "next/server";
import { withErrorHandler } from "@/lib/errors";
import { getDeveloperIntegration, generateMarkdownDocumentation } from "@/features/notifications-platform";
