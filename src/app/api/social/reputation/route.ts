...
export const GET = withErrorHandler(async (req: Request) => {
  ...
  const targetId = resolveTargetUserId(ctx, searchParams.get('userId')); return NextResponse.json({ reputation: getReputationForUser(targetId), top: getTopReputableUsers(10) });
});
